...
async function fetchWeWorkRemotely() {
    try {
        const rssData = await safeFetch("https://weworkremotely.com/categories/remote-programming-jobs.rss");
        ...
        console.log("WeWorkRemotely parse failed");
        return [];
    }
}
...
async function fetchAndStoreJobs() {
    try {
        ...
        const combined = [...remotiveJobs, ...arbeitnowJobs, ...wwrJobs];
